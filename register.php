...
body{
	...
	<div class="container">
		...
		<form action="register.php" method="POST">
			...
			Enter Mobile-No : <input type="number" name="phnnumber" required="required"/><br/>
...
<?php
	if($_SERVER["REQUEST_METHOD"]=="POST")
	{
		...
		$phnnumber = mysql_real_escape_string($_POST['phnnumber']);
		$bool=true;
		...
		if($bool)
		{
			mysql_query("INSERT INTO users (username,password,mobile-no) VALUES ('$username','$password','$phnnumber')");
